...
api.prototype.processResponse = function(options, err, res, done) {
    ...
    if ((options.status_code && options.status_code !== res.status_code) || (options.status_codes && options.status_codes.indexOf(res.status_code) === -1)) {
